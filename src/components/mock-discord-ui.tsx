    ...
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-discord-background cursor-not-allowed"
          >
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* message input */}
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1 w-full">
